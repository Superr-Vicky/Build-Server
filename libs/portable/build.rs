fn main() {
    #[cfg(windows)]
    {
        ...
        let product_name = option_env!("CUSTOM_APP_NAME").unwrap_or("RustDesk");
        let product_description = option_env!("CUSTOM_APP_DESCRIPTION").unwrap_or("RustDesk Remote Desktop");
